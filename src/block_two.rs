...
pub fn dispatch(instr: u8, console: &mut Console) -> () {
    ...
    let op: u8 = (instr << 2) >> 5;
    match op {
        0 => arithm_a_imm8::<ADD, NO_CARRY>(r8, console),
        1 => arithm_a_imm8::<ADD, CARRY>(r8, console),
        2 => arithm_a_imm8::<SUB, NO_CARRY>(r8, console),
        3 => arithm_a_imm8::<SUB, CARRY>(r8, console),
